...
public class DesignerBoardController {
  ...
  public ResponseEntity<? super GetDesignerBoardResponseDto> getDesignerBoard(
      @PathVariable("designerBoardNumber") int designerBoardNumber) {
    ResponseEntity<? super GetDesignerBoardResponseDto> response = designerBoardService
        .getDesignerBoard(designerBoardNumber);
    return response;
  }
  ...
  // public ResponseEntity<? super GetDesignerBoardCommentResponseDto>
  // getDesignerBoardComment (
  // @PathVariable("designerBoardCommentNumber") int designerBoardCommentNumber
  // ) {
  // ResponseEntity<? super GetDesignerBoardCommentResponseDto> response =
  // designerBoardService.getDesignerBoardComment(designerBoardCommentNumber);
  // return response;
  // }
